...
class Env:
    ...
    def step(self, action):
        ...
        if action == 0:
            ...
            # 'x' should be increased by 1 or stat the same when it is at the bottom row
            ...
            # 'x' should be decreased by 1 or staty the same when it is at the most left column
