...
def eva_agent_with_rendering(config, env, agent):
    score_sum = 0
    step_count_sum = 0
...
def parser_args():
    ...
    parser.add_argument('--model_path', type=str, help='Specify the path to be evaluated')
...
if __name__ == "__main__":
    ...
    eva_agent_with_rendering(config, env, agent)