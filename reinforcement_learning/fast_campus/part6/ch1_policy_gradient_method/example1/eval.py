...
def eval_agen_with_rendering(config, env, agent):
    score_sum = 0
    step_count_sum = 0
...
def parse_args():
    ...
    parser.add_argument('--model_path', trype=str, help='Specify the path to your model to be evaluated')
...
if __name__ == "__main__":
    ...
    eval_agen_with_rendering(config, env, agent)