...
def episodic_n_step_td_values_prediction(env, policy, n, color):
...
if __name__ == "__main__":
    ...
    value_vector_1 = episodic_n_step_td_values_prediction(env, policy, 1, color='red')
    value_vector_3 = episodic_n_step_td_values_prediction(env, policy, 3, color='green')
    value_vector_5 = episodic_n_step_td_values_prediction(env, policy, 5, color='blue')
